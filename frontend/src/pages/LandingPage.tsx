...
export function LandingPage() {
  ...
  useEffect(() => {
    if (!pdfResult) { setGeneratedPreviewUrl(null); return; }
  ...
  const resetConversion = () => { setConversionError(null); setConversionProgress(null); setPdfResult(null); setHistoryWarning(null); setIsGeneratedPreviewOpen(false); };
